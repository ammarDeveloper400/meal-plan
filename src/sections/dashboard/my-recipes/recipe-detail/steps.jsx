...
const Steps = () => {
  ...
  return (
    <Box>
      <Typography sx={{ fontSize: '20px !important', fontWeight: '700', pb: {xl:'10px',lg:'0px'} }}>
        {recipeData.title}
      </Typography>
      ...
      <Typography sx={{ fontSize: '14px !important', fontWeight: '500', pb: {xl:'10px',lg:'0px'} }}>
      ...
      <Typography sx={{ fontSize: '14px !important', fontWeight: '500', pb: '2px' }}>
