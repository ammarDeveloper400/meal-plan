...
import { Box, Grid, Card, Button, Tooltip, CardMedia, TextField, Typography, IconButton } from '@mui/material';

// import MealTable from '../meal-consult/mealtable'
import MealTable from './mealtable';
import Iconify from '../../../components/iconify';
import TooltipCard from '../meal-consult/tooltipcard';
      ...
      {isEditing ? (
        ...
        <Typography sx={{ fontSize: '20px !important', fontWeight: '600 !important' }}>
          {text}
            ...
            {/* <Typography sx={{ fontSize: '20px !important', fontWeight: '600 !important',ml: '5px' }}>Week#34</Typography> */}
      ...
      >
        ...
        >
          ...
          >
            ...
            <Typography  sx={{ fontSize: '12px !important', fontWeight: '400 !important' }}>Week #34 2023-03-06</Typography>
          </Box>
        ...
        <Box sx={{ minWidth: '1000px' }}>
          ...
          <Grid container spacing={2} pt={3}>
            <Grid item xs={1.2} />
            {recipeList.map((recipe) => (
              <Grid item xs={1.57} key={recipe.id}>
