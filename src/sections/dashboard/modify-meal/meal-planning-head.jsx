  ...
  return (
    <>
      <Box pt="35px">
        ...
        <Box sx={{ border: '1px solid #000', borderRadius: '10px', px: '20px',pt:'10px', width: '100%' }}>
          <Box
            sx={{
              display: 'flex',
              flexDirection: { xs: 'column', sm: 'row' },
          ...
          >
            ...
            <Box display='flex' flexDirection='column' alignItems={{sm:'flex-end',xs:'center'}}>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'end' ,mt:'27px',mb:'10px', px:{xs:'30px'}}}>
            <Tabs
  value={activeTab}
