...
const recipeData = {
  ...
  optional: 'This section should only appear if the admin add something-optional text field.',
  description:
...
const Steps = () => {
  ...
  return (
    <Box>
      <Typography sx={{ fontSize: '20px !important', fontWeight: '700', pb: {md: '4px', lg: '4px'} }}>
        {recipeData.title}
      </Typography>

      {/* <Typography sx={{ fontSize: '14px !important', fontWeight: '600', pb: {md:'0px', lg: '10px'} }}>
        {recipeData.subtitle}
      </Typography> */}
      <Typography
        sx={{ fontSize: '14px !important', fontWeight: '500', pb: {lg:'10px', md:'7px'}, lineHeight: '1.5rem'}}
      >
