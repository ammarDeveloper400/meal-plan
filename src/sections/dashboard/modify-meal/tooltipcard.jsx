...
const TooltipCard = ({ setOpenDeleteMealDialog }) => {
  ...
  const handleSelectSortOrder = (order) => {
    ...
    setAnchorEl(null); // Close only the dropdown menu
  };
              ...
              <Stack spacing={2}>
                <Box sx={{ display: 'flex', gap: 2, }}>
                  ...
                  <Button
                    ...
                    onClick={() => setOpenDeleteMealDialog(true)} // Use the new function to open dialog
                  >
                    Delete
                    <Iconify
                      sx={{ color: '#fff', width: '12px', height: '12px' }}
