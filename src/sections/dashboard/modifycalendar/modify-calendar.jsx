...
import MealTable from '../modify-meal/mealtable';
        ...
        {['Breakfast', 'Lunch', 'Dinner', 'Dessert', 'Snack', 'Add on'].map((meal, mealIndex) => (
          <Grid container spacing={2} key={mealIndex} sx={{ pt: '20px' }}>
            ...
            {recipeList.map((recipe, index) => (
              <Grid item xs={1.5} key={index}>
                <Tooltip
                  ...
                  title={<Box sx={{ zIndex: 1 }}>
                    <TooltipCard setOpenDeleteDialog={setOpenDeleteDialog} />
                  </Box>}
                  placement="top"
                  arrow
                >
            ...
            <Grid xs={1.5}>
              ...
              >
                <Box onClick={() => navigate('/meal/add-meal')} ml={2}>
                  <img style={{ cursor: 'pointer' }} src="/assets/icons/plusicon.svg" alt="plus" />
                </Box>
              </Box>
            </Grid>
            <Grid xs={2}>
              ...
              >
                <Box onClick={() => navigate('/meal/add-meal')}>
                  <img style={{ cursor: 'pointer' }} src="/assets/icons/plusicon.svg" alt="plus" />
                </Box>
              </Box>
            </Grid>
