...
const TooltipCard = ({ setOpenDeleteDialog }) => {
  ...
  const handleSelectSortOrder = (order) => {
    setSortOrder(order); // Update sortOrder with selected portion
    // No need to close the menu here, so handleCloseMenu is removed.
  };
              ...
              <Stack spacing={2}>
                <Box sx={{ display: 'flex', gap: 3 }}>
                  ...
                  >
                    Modify
                    <Iconify
                      sx={{ color: '#fff', width: '12px', height: '12px' }}
                  ...
                  <Button
                    ...
                    onClick={() => setOpenDeleteDialog(true)} // Use the new function to open dialog
                  >
                    Delete
                    <Iconify
                      sx={{ color: '#fff', width: '12px', height: '12px' }}
